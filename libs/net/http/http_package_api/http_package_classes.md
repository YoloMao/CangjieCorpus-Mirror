...
- value: [String](../../../std/core/core_package_api/core_package_structs.md#struct-string) - cookie-value 属性。
...
- url: [String](../../../std/core/core_package_api/core_package_structs.md#struct-string) - 重定向响应中 Location 头部的 url。
- code: [UInt16](../../../std/core/core_package_api/core_package_intrinsics.md#uint16) - 重定向响应的响应码。
...
> - 提供 tls 证书热机制；
> - 提供 shutdown 回调机制；
> - 通过 [Logger](../../../std/log/stdlog_package_api/stdlog_package_interfaces.md#interface-logger).level 开启、关闭日志打印，包括按照用户要求打印相应级别的日志；
...
功能：获取服务端监听地址，格式为 [IP](../../../crypto/x509/x509_package_api/x509_package_type.md#type-ip) 或者 域名。
...
类型：[ServerSocket](../../../std/socket/socket_package_api/socket_package_interfaces.md#interface-serversocket)
...
功能：注册服务器启动时的回调函数，服务内部 [ServerSocket](../../../std/socket/socket_package_api/socket_package_interfaces.md#interface-serversocket) 实例 bind 之后，accept 之前将调用该函数。重复调用将覆盖之前注册的函数。

参数：

- f: () ->[Unit](../../../std/core/core_package_api/core_package_intrinsics.md#unit) - 回调函数，入参为空，返回值为 [Unit](../../../std/core/core_package_api/core_package_intrinsics.md#unit) 类型。
...
- 请求头 "content-length" 其 value 必须能解析为 [Int64](../../../std/core/core_package_api/core_package_intrinsics.md#int64) 类型，且不能为负值，否则返回 400 响应，当其 value 值超出 server 设定maxRequestBodySize，将返回 413 响应；
...
- 如果有 "content-length" header，需符合 "content-length" 每个值都能解析为 [Int64](../../../std/core/core_package_api/core_package_intrinsics.md#int64) 类型，且如果有多个值，必须相等，否则关闭流；
...
- 如果 method 为 "HEAD"，则：
    - headers 包含 "content-length"，但 "content-length" 不合法（无法被解析为 [Int64](../../../std/core/core_package_api/core_package_intrinsics.md#int64) 值，或包含多个不同值），如果用户调用 [HttpResponseWriter](http_package_classes.md#class-httpresponsewriter) 类的 write 函数，将抛出 [HttpException](http_package_exceptions.md#class-httpexception)，如果用户 handler 已经结束，将打印日志；
...
- [SocketException](../../../std/socket/socket_package_api/socket_package_exceptions.md#class-socketexception) - 当端口监听失败时，抛出异常。
...
- newCa: [Array](../../../std/core/core_package_api/core_package_structs.md#struct-arrayt)\<[X509Certificate](../../../crypto/x509/x509_package_api/x509_package_classes.md#class-x509certificate)> - CA证书。

异常：

- [IllegalArgumentException](../../../std/core/core_package_api/core_package_exceptions.md#class-illegalargumentexception) - 参数包含空字符时抛出异常。
...
- newCaFile: [String](../../../std/core/core_package_api/core_package_structs.md#struct-string) - CA证书文件。
...
- certChain: [Array](../../../std/core/core_package_api/core_package_structs.md#struct-arrayt)\<[X509Certificate](../../../crypto/x509/x509_package_api/x509_package_classes.md#class-x509certificate)> - 证书链。
...
- certificateChainFile: [String](../../../std/core/core_package_api/core_package_structs.md#struct-string) - 证书链文件。
- privateKeyFile: [String](../../../std/core/core_package_api/core_package_structs.md#struct-string) - 证书匹配的私钥文件。
...
- addr: [String](../../../std/core/core_package_api/core_package_structs.md#struct-string) - 地址值，格式为 [IP](../../../crypto/x509/x509_package_api/x509_package_type.md#type-ip) 或者 域名。
...
功能：根据设置的属性构建 [Server](http_package_classes.md#class-server) 实例。
...
- [IllegalArgumentException](../../../std/core/core_package_api/core_package_exceptions.md#class-illegalargumentexception) - 当设置的参数非法时，抛出异常。
...
- flag: [Bool](../../../std/core/core_package_api/core_package_intrinsics.md#bool) - 本端是否接收 CONNECT 请求。
...
- size: [UInt32](../../../std/core/core_package_api/core_package_intrinsics.md#uint32) - 本端对响应头编码时使用的最大 `table size`
...
- timeout: [Duration](../../../std/time/time_package_api/time_package_structs.md#struct-duration) - 设定保持长连接的超时时间，如果传入负的 [Duration](../../../std/time/time_package_api/time_package_structs.md#struct-duration) 将被替换为 [Duration](../../../std/time/time_package_api/time_package_structs.md#struct-duration).Zero。
...
- size: [UInt32](../../../std/core/core_package_api/core_package_intrinsics.md#uint32) - 本端一个 stream 上接收报文的初始流量窗口大小。
...
- listener: [ServerSocket](../../../std/socket/socket_package_api/socket_package_interfaces.md#interface-serversocket) - 所绑定的socket。
...
功能：设定服务器的 logger，默认 logger 级别为 INFO，logger 内容将写入 [Console](../../../std/console/console_package_api/console_package_class.md#class-console).stdout。
...
- size: [UInt32](../../../std/core/core_package_api/core_package_intrinsics.md#uint32) - 本端同时处理的最大请求数量。
...
- size: [UInt32](../../../std/core/core_package_api/core_package_intrinsics.md#uint32) - 本端接收的一个帧的最大长度。
...
- size: [UInt32](../../../std/core/core_package_api/core_package_intrinsics.md#uint32) - 本端接收的报文头最大长度。
...
- size: [Int64](../../../std/core/core_package_api/core_package_intrinsics.md#int64) - 设定允许接收请求的请求体大小最大值，值为 0 代表不作限制。
...
- [IllegalArgumentException](../../../std/core/core_package_api/core_package_exceptions.md#class-illegalargumentexception) - 当入参size < 0时，抛出异常。
...
- size: [Int64](../../../std/core/core_package_api/core_package_intrinsics.md#int64) - 设定允许接收请求的请求头大小最大值，值为 0 代表不作限制。
...
- port: [UInt16](../../../std/core/core_package_api/core_package_intrinsics.md#uint16) - 端口值。
...
- timeout: [Duration](../../../std/time/time_package_api/time_package_structs.md#struct-duration) - 设定的读请求头超时时间，如果传入负的 [Duration](../../../std/time/time_package_api/time_package_structs.md#struct-duration) 将被替换为 [Duration](../../../std/time/time_package_api/time_package_structs.md#struct-duration).Zero。
...
- timeout: [Duration](../../../std/time/time_package_api/time_package_structs.md#struct-duration) - 设定读请求的超时时间，如果传入时间为负值将被替换为 [Duration](../../../std/time/time_package_api/time_package_structs.md#struct-duration).Zero。
...
- timeout: [Duration](../../../std/time/time_package_api/time_package_structs.md#struct-duration) - 设定写响应的超时时间，如果传入时间为负值将被替换为 [Duration](../../../std/time/time_package_api/time_package_structs.md#struct-duration).Zero。
...
- subProtocols!: [ArrayList](../../../std/collection/collection_package_api/collection_package_class.md#class-arraylistt)\<[String](../../../std/core/core_package_api/core_package_structs.md#struct-string)> - 用户配置的子协议列表，按偏好排名，默认为空。若用户配置了，则会随着升级请求发送给服务器。
...
- [SocketException](../../../std/socket/socket_package_api/socket_package_exceptions.md#class-socketexception) - 底层连接错误时抛出异常。
...
- subProtocols!: [ArrayList](../../../std/collection/collection_package_api/collection_package_class.md#class-arraylistt)\<[String](../../../std/core/core_package_api/core_package_structs.md#struct-string)> - 用户配置的子协议列表，默认值为空，表示不支持。如果用户配置了，则会选取升级请求中最靠前的作为升级后的 [WebSocket](http_package_classes.md#class-websocket) 的子协议，用户可通过调用返回的 [WebSocket](http_package_classes.md#class-websocket) 的 subProtocol 查看子协议。
- origins!: [ArrayList](../../../std/collection/collection_package_api/collection_package_class.md#class-arraylistt)\<[String](../../../std/core/core_package_api/core_package_structs.md#struct-string)> - 用户配置的同意握手的 origin 的白名单，如果不配置，则同意来自所有 origin 的握手，如果配置了，则只接受来自配置 origin 的握手。
...
read 函数返回一个 [WebSocketFrame](http_package_classes.md#class-websocketframe) 对象，用户可以调用 [WebSocketFrame](http_package_classes.md#class-websocketframe) 的 frameType，fin 属性确定其帧类型和是否是分段帧调用。通过 [WebSocketFrame](http_package_classes.md#class-websocketframe) 的 payload 函数得到原始二进制数据数组：[Array](../../../std/core/core_package_api/core_package_structs.md#struct-arrayt)\<[UInt8](../../../std/core/core_package_api/core_package_intrinsics.md#uint8)>
...
> **注意：**
>
> - 数据帧（Text，Binary）可以分段，用户需要多次调用 read 将所有分段帧读完（以下称为接收到完整的 message），再将分段帧的 payload 按接收序拼接Text 帧的 payload 为 UTF-8 编码，用户在接收到完整的 message 后，调用 [String](../../../std/core/core_package_api/core_package_structs.md#struct-string).fromUtf8函数将拼接后的 payload 转成字符串Binary 帧的 payload 的意义由使用其的应用确定，用户在接收到完整的 message 后，将拼接后的 payload 传给上层应用；
...
- [SocketException](../../../std/socket/socket_package_api/socket_package_exceptions.md#class-socketexception) - 底层连接错误。
...
- byteArray: [Array](../../../std/core/core_package_api/core_package_structs.md#struct-arrayt)\<[UInt8](../../../std/core/core_package_api/core_package_intrinsics.md#uint8)> - 所需发送的帧的 payload（二进制形式）。
- frameSize!: [Int64](../../../std/core/core_package_api/core_package_intrinsics.md#int64) - 分段帧的大小，默认为 4 * 1024 bytes，frameSize 不会对控制帧生效（控制帧设置了无效）。
...
- status!: ?[UInt16](../../../std/core/core_package_api/core_package_intrinsics.md#uint16) - 发送的 Close 帧的状态码，默认为 None，表示不发送状态码和 reason。
- reason!: [String](../../../std/core/core_package_api/core_package_structs.md#struct-string) - 关闭连接的说明，默认为空字符串，发送时会转成 UTF-8，不保证可读，debug 用。
